...
public class MsgPhraseCI
{

    /** The definitions. */
    private final List<MsgPhraseCIDefinition> definitions = new ArrayList<MsgPhraseCIDefinition>();
     ...
     */
    public List<MsgPhraseCIDefinition> getDefinitions()
    {
     ...
     */
    @SetNext
    public void addDefinition(final MsgPhraseCIDefinition _definition)
    {
